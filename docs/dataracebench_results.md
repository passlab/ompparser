...
DRB026-targetparallelfor-orig-yes.c | ` #pragma omp target map(a[0:len]) ` | ` #pragma omp target map (a[0:len]) ` | true
...
DRB071-targetparallelfor-orig-no.c | ` #pragma omp target map(a[0:len]) ` | ` #pragma omp target map (a[0:len]) ` | true
...
DRB094-doall2-ordered-orig-no.c | ` #pragma omp ordered depend(sink:i-1,j) depend (sink:i,j-1) ` | ` #pragma omp ordered depend (sink : i-1, j, i, j-1) ` | true
...
DRB103-master-orig-no.c | ` #pragma omp master ` | ` #pragma omp master  ` | true
...
DRB112-linear-orig-no.c | ` #pragma omp parallel for linear(j) ` | ` #pragma omp parallel for linear (j) ` | true
